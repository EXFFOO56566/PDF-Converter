package com.tochy.pdf.fragment;
...
import com.tochy.pdf.activities.ActivityImageEditor;
import com.tochy.pdf.activities.ActivityPreview;
import com.tochy.pdf.activities.HomeActivity;
import com.tochy.pdf.util.AdsUtility;
...
import com.tochy.pdf.activities.ActivityCropImage;
import com.tochy.pdf.activities.ActivityRearrangeImages;
import com.tochy.pdf.adapter.AdapterEnhancementOptions;
import com.tochy.pdf.db.DatabaseHelper;
import com.tochy.pdf.interfaces.OnItemClickListener;
import com.tochy.pdf.interfaces.OnPDFCreatedInterface;
import com.tochy.pdf.pdfModel.EnhancementOptionsEntity;
import com.tochy.pdf.pdfModel.ImageToPDFOptions;
import com.tochy.pdf.pdfModel.Watermark;
import com.tochy.pdf.Constants;
import com.tochy.pdf.util.CreatePdf;
import com.tochy.pdf.util.DefaultTextWatcher;
import com.tochy.pdf.util.DialogUtils;
import com.tochy.pdf.util.FileUtils;
import com.tochy.pdf.util.ImageEnhancementOptionsUtils;
import com.tochy.pdf.util.ImageUtils;
import com.tochy.pdf.util.MorphButtonUtility;
import com.tochy.pdf.util.PageSizeUtils;
import com.tochy.pdf.util.PermissionsUtils;
import com.tochy.pdf.util.SharedPreferencesUtil;
import com.tochy.pdf.util.StringUtils;

import static com.tochy.pdf.Constants.DEFAULT_BORDER_WIDTH;
import static com.tochy.pdf.Constants.DEFAULT_COMPRESSION;
import static com.tochy.pdf.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static com.tochy.pdf.Constants.DEFAULT_IMAGE_SCALE_TYPE_TEXT;
import static com.tochy.pdf.Constants.DEFAULT_PAGE_COLOR;
import static com.tochy.pdf.Constants.DEFAULT_PAGE_SIZE;
import static com.tochy.pdf.Constants.DEFAULT_PAGE_SIZE_TEXT;
import static com.tochy.pdf.Constants.DEFAULT_QUALITY_VALUE;
import static com.tochy.pdf.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
import static com.tochy.pdf.Constants.MASTER_PWD_STRING;
import static com.tochy.pdf.Constants.OPEN_SELECT_IMAGES;
import static com.tochy.pdf.Constants.READ_PERMISSIONS;
import static com.tochy.pdf.Constants.REQUEST_CODE_FOR_READ_PERMISSION;
import static com.tochy.pdf.Constants.REQUEST_CODE_FOR_WRITE_PERMISSION;
import static com.tochy.pdf.Constants.RESULT;
import static com.tochy.pdf.Constants.STORAGE_LOCATION;
import static com.tochy.pdf.Constants.WRITE_PERMISSIONS;
import static com.tochy.pdf.Constants.appName;
import static com.tochy.pdf.util.WatermarkUtils.getStyleNameFromFont;
import static com.tochy.pdf.util.WatermarkUtils.getStyleValueFromName;
