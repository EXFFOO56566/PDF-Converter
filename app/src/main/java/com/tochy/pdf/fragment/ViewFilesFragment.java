...
import com.tochy.pdf.adapter.AdapterViewFiles;
import com.tochy.pdf.interfaces.EmptyStateChangeListener;
import com.tochy.pdf.interfaces.ItemSelectedListener;
import com.tochy.pdf.util.AdsUtility;
import com.tochy.pdf.util.DialogUtils;
import com.tochy.pdf.util.DirectoryUtils;
import com.tochy.pdf.util.FileSortUtils;
import com.tochy.pdf.util.MergeHelper;
import com.tochy.pdf.util.PermissionsUtils;
import com.tochy.pdf.util.PopulateList;
import com.tochy.pdf.util.StringUtils;
import com.tochy.pdf.util.ViewFilesDividerItemDecoration;

import static com.tochy.pdf.Constants.BUNDLE_DATA;
import static com.tochy.pdf.Constants.REQUEST_CODE_FOR_WRITE_PERMISSION;
import static com.tochy.pdf.Constants.SORTING_INDEX;
